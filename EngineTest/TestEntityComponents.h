...
private:
	void create_random()
	{
		...
		{
			++_added;
			game_entity::entity entity{ game_entity::create_game_entity(entity_info) };     //DEVIATION, if error try   			game_entity::create_game_entity(entity_info);
	...
	void print_results()
	{
		printf("Entities Created %i \n", _added);
		printf("Entities Deleted %i \n", _removed);
	}
